module.exports = {
  ...
  "parserOptions": {
    "sourceType": "module" // allow es2015 import, export
  },
  ...
  "rules": {
    ...
    //
    "block-scoped-var": 1, // treat var statements as if they were block scoped (off by default). 0: deep destructuring is not compatible https://github.com/eslint/eslint/issues/1863
    ...
    "func-names": [1, "never"], // require function expressions to have a name (off by default)
    ...
    "one-var": [1, "always"], // allow just one var statement per function (off by default)
